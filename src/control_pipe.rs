...
#[cfg(all(not(feature = "control-buffer-1024"), not(feature = "control-buffer-512"), feature = "control-buffer-256"))]
const CONTROL_BUF_LEN: usize = 256;
#[cfg(all(not(feature = "control-buffer-1024"), not(feature = "control-buffer-512"), not(feature = "control-buffer-256")))]
